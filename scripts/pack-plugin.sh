...
# slug, e.g. tabletop-events-carpool/tabletop-events-carpool.php rather than loose
# files at the zip root, or GitHub's own "Download ZIP" folder name
# (tabletop-events-carpool-main/). WordPress needs that single top-level
